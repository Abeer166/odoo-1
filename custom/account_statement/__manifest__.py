...
""",
    ...
    'depends': ['base','website', 'account', 'sale_management', 'mail', 'sales_team','sale'],
    ...
    'data': ['security/ir.model.access.csv',
            'views/report.xml',
             ...
             'views/monthly_supplier_statement_report.xml',
             'views/weekly_report.xml',
             'views/weekly_supplier_report.xml',
             'views/mail_data.xml',
             'views/res_partner_view.xml',
             'views/overdue_report.xml',
             'views/overdue_supplier_report.xml',
             'views/due_report.xml',
             'views/due_supplier_report.xml',
             'views/customer_statement_portal_view.xml',
