...
class ReportSaleDetails(models.AbstractModel):
    ...
    _name = 'report.sh_sale_details_report.sh_sale_details_report_doc'
                ...
                for invoice in invoices:
                    ...
                    if payments:
                        for payment in payments:
                            paid_total = paid_total+ payment.amount
    ...
    def _get_report_values(self, docids, data=None):
        ...
        data.update(self.get_sale_details(data['date_start'],
                                          data['date_stop'], team_ids, company_ids,
                                          data['state']))
        return data
