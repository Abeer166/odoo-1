...
class ReportGeneralLedger(models.AbstractModel):
    _name = 'report.branchreportcc.report_general_ledger'
    ...
    def _get_account_move_entry(self, accounts, analytic_account_ids,
        ...
        if sortby == 'sort_journal_partner':
            sql_sort = 'b.name, j.code,  p.name, l.move_id'
        ...
        sql = ('''SELECT l.id AS lid, l.account_id AS account_id, 
            l.date AS ldate, j.code AS lcode, b.name AS lbranch, l.currency_id, 
            ...
            l.account_id, l.date, j.code, b.name, l.currency_id, l.amount_currency, 
    ...
    def _get_report_values(self, docids, data=None):
        ...
        branches = []
        if data['form'].get('branch_ids', False):
            branches = [branch.name for branch in
                     self.env['res.branch'].search(
                         [('id', 'in', data['form']['branch_ids'])])]
