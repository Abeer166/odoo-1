...
class AccountingReport(models.TransientModel):
    ...
    def check_report(self):
        ...
        data = {}
        data['form'] = self.read(['account_report_id', 'date_from_cmp', 'date_to_cmp', 'journal_ids', 'branch_ids', 'filter_cmp', 'target_move'])[0]
    ...
    def _print_report(self, data):
        ...
        return self.env.ref('branchreportcc.action_report_financial').report_action(self, data=data, config=False)
