...
class AccountCommonReport(models.TransientModel):
    ...
    branch_ids = fields.Many2many(
        ...
        string='Branches',
        required=False,
        default=lambda self: self.env['res.branch'].search([('company_id', '=', self.company_id.id)]),
    )
    ...
    def check_report(self):
        ...
        data['form'] = self.read(['date_from', 'date_to', 'journal_ids', 'branch_ids', 'target_move', 'company_id'])[0]
